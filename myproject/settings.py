...
A comprehensive social networking platform with real-time features,
advanced search, and mobile API support.
...
# Disable Elasticsearch autosync in development when ES may not be running
